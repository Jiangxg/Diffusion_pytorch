#################################################################################
#Borrowed from: 
# https://github.com/lucidrains/denoising-diffusion-pytorch/blob/5ff2393c72a2a678535ac1c31779684552f18189/denoising_diffusion_pytorch/guided_diffusion.py
#
#################################################################################
import math
import copy
...
class Unet(nn.Module):
    def __init__(
        ...
        self.channels = channels  # 3颜色通道
        self.self_condition = self_condition  # False
        input_channels = channels * (2 if self_condition else 1)  # input_channels = 3
